...
import com.alignsolution.siamsmilemobileapplication.Adapter.Pay2_Adapter;
...
public class Pay2Activity extends AppCompatActivity  implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pay_customer_main);
        try {
       ...
       // SetMenu();
        ...
        //menu slide
        Pay2_Adapter adapter0=new Pay2_Adapter(Pay2Activity.this,
                itemname1, arrImg);
