...
public class Activity_DetailCustomerClaims extends AppCompatActivity implements AdapterView.OnItemClickListener  {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detailcustomerclaims);
        try{
...
//                        .setAction("Action", null).show();
                Intent intent = new Intent(getBaseContext(),Activity_Claims.class);
