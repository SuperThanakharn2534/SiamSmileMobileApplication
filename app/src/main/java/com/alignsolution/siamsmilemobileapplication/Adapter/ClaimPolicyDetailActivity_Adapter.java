...
import com.alignsolution.siamsmilemobileapplication.ClaimPolicyDetailActivity;
...
public class ClaimPolicyDetailActivity_Adapter extends ArrayAdapter<String> {
    ...
    public ClaimPolicyDetailActivity_Adapter(ClaimPolicyDetailActivity context,
