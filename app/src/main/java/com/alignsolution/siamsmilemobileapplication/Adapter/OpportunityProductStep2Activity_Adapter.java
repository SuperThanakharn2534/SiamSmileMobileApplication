...
public class OpportunityProductStep2Activity_Adapter extends ArrayAdapter<String> {
    ...
    public OpportunityProductStep2Activity_Adapter(OpportunityProductStep2Activity context,
