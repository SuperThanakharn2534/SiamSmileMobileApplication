...
import com.alignsolution.siamsmilemobileapplication.OpportunityDetailActivity;
...
public class OpportunityDetailActivity_Adapter extends ArrayAdapter<String> {
    ...
    public OpportunityDetailActivity_Adapter(OpportunityDetailActivity context,
