...
import com.alignsolution.siamsmilemobileapplication.OpportunityProductSuccess;
...
public class OpportunityProductSuccessAdapter  extends ArrayAdapter<String> {
    ...
    public OpportunityProductSuccessAdapter(OpportunityProductSuccess context,
