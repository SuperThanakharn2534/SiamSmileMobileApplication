...
import com.alignsolution.siamsmilemobileapplication.NoticeScoreActivity;
import com.alignsolution.siamsmilemobileapplication.NoticeScoreActivity2;
...
public class NoticeScoreActivity_Adapter extends ArrayAdapter<String> {
    private final Activity context;
    private final String[] web;
    private final Integer[] imageId;


    public NoticeScoreActivity_Adapter(NoticeScoreActivity context,
