...
import com.alignsolution.siamsmilemobileapplication.Pay2Activity;
...
public class Pay2_Adapter extends ArrayAdapter<String> {
    private final Activity context;
    private final String[] web;
    private final Integer[] imageId;


    public Pay2_Adapter(Pay2Activity context,
