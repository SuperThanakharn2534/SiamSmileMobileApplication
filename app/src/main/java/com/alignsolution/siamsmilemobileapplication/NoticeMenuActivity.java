...
public class NoticeMenuActivity extends AppCompatActivity  implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //menu slide
        NoticeMenuActivity_Adapter adapter=new NoticeMenuActivity_Adapter(NoticeMenuActivity.this,
                itemname1, arrImg);
        ...
        img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(getBaseContext(),NoticeNewsActivity.class));
            }
        });
        ...
        img2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(getBaseContext(),NoticeScoreActivity.class));
            }
        });
