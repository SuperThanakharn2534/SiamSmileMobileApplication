...
import com.alignsolution.siamsmilemobileapplication.Adapter.OpportunityProductSuccessAdapter;
...
public class OpportunityProductSuccess extends AppCompatActivity  implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_opportunity_product_success);
        try {


         SetMenu();
        //menu slide
        OpportunityProductSuccessAdapter adapter1=new OpportunityProductSuccessAdapter(OpportunityProductSuccess.this,
                itemname, arrImg);
        ...
        button18.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getBaseContext(),OpportunityProductSuccessPay.class));
            }
        });
